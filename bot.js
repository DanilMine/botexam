...
bot.action('part', async (ctx, next) => {
    ...
    msgForDelete = [];
    await waitFor(500);
    bot.telegram.sendMessage(ctx.chat.id,  'Панелька Глав. В случае каких-то багов можете вернуться в начало главы, или при желании переиграть момент. \n\nНо при переигрывании конечный результат  может сломаться. Начинайте играть с начала!!!', {
        reply_markup: {
            inline_keyboard: [
                [
...
bot.action('page0_0', async (ctx, next) => { 
    ...
    bot.telegram.sendPhoto(ctx.chat.id, {
        source: "photos/gloomy_forest.jpg"}).then((result) =>{msgForDelete.push(result.message_id);});
    await waitFor(500);
	bot.telegram.sendMessage(ctx.chat.id,'Сандро очнулся в лесу. Где он и что происходит, он не понимал.',{
        reply_markup: {
...
bot.action('page0_t_0', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Немного подумав, вы решили, что противоположностью назад, может быть только прямо. Дорожка прямо была хорошо проложена, вы были уверенны, что рано или поздно вы выйдите из этого леса...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
...
bot.action('page0_t_1', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Солнечный свет был все ярче и ярче. Вы почти покинули этот лес.').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);});
    await waitFor(500);
...
bot.action('page0_r_0', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Чтобы не идти прямо, но и не назад вы решили пойти направо. Конечно, это было бы более правильно назвать по диагонале, но это было не важно...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);});
...
bot.action('page0_r_0_0', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Вы решили остаться и найти что-то полезное...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Где-то вдали вам послышались звуки диких животных, возможно они опасны...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
...
bot.action('page0_r_0_1', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Вы сели на бревно и стали смотреть в огонь.').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Справа от другого бревна лежала какая-то записка, заметив её, вы пересели на то древно и стали читать её.').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
...
bot.action('page0_r_1', async (ctx, next) => {
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'У вас времени не было развлекаться у привала, вы шли уже по более хорошей дорожке и сейчас вам казалось, что выход уже рядом...').then((result) =>{msgForDelete.push(result.message_id);});
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page0_d_0', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id, 'Пройдя далее дорожка закончилась, но вы все же думали, что выход рядом... Очевидно было, что его здесь нет, но вы не сдавались...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
        source: "photos/f_end.jpg"
    }).then((result) =>{msgForDelete.push(result.message_id);}); 
...
bot.action('page0_3_0', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Вы решили взглянуть на плиты...').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);});
    await waitFor(500);
...
bot.action('page0_3', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Вы подошли к воротам. Сами ворота были высотой метров 10, а стены вокруг еще больше. Странно, что вы не увидели это здание еще в лесу, но вы понимали, что вся проблема была в тумане.').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
...
bot.hears(regex, async (ctx, next) => {
    console.log(ctx.from)
    await waitFor(500);
 await bot.telegram.sendMessage(ctx.chat.id,'Прошу, вводите только корректные данные').then((result) =>{msgForDelete.push(result.message_id);}); 
})
...
bot.hears('Александр', async (ctx, next) => { 
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Что!? Но ведь ты должен был уже быть за вратами... Твоё место, Александр, в Раю, но по ошибке ты оказался в этом лесу... Извини, что не узнал, просто сегодня еще кое-кто должен прийти. Так что назови мне свой номер и ты можешь проходить дальше. Главное, подойди к Харону, он тебя проведет...Так вот, я слушаю.').then((result) =>{msgForDelete.push(result.message_id);});
 })
...
bot.action('page0_5_5', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Старик в черном немного был удивлен. Он был несомненно уверен, что единственный, кто мог сейчас прийти из леса - это был Сандро. Но он не мог видеть его лица, у него не было глаз. Конечно, по такой логике, он не мог и слышать, но такая возможность у него была и была намного развитой, чем у других.').then((result) =>{msgForDelete.push(result.message_id);}); 
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'- Допустим, и как же тебя зовут?').then((result) =>{msgForDelete.push(result.message_id);});
	await bot.telegram.sendMessage(ctx.chat.id,'Напишите ваше имя (Пример: Сандро)').then((result) =>{msgForDelete.push(result.message_id);});
})
...
bot.action('page1_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'- Здравствуйте, ваше имя Харон?').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Он внимательно посмотрел на вас и сказал:\n- Здравствуй, назви своё имя и я, Харон, назову твой приговор. ').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Пример текста(соблюдайте в точности большие буквы): Моё имя Сандро').then((result) =>{msgForDelete.push(result.message_id);});   
})
...
bot.action('page1_2', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Вы направились к парню, которому целовали руки... ').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
...
bot.action('page1_3_1', async (ctx, next) => {
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Так и быть - Я освежу твою память!').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
...
bot.action('page1_3_0', async (ctx, next) => {
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Так и быть - Я поведаю тебе эту тайну.').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
...
bot.action('page1_4', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Вы направились в место, где была оставлена лодка для вас. Она была немного дальше от Харона и закрыта скалами и деревьями от грешников.').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Проверив все ли на месте, вы убедились, что плыть можно. Он говорил, что ваша задача плыть по этому озеру прямо и тогда вы доплывёте до Ворот.').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
...
bot.action('page1_6_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Вы решили помочь ему. Благородный поступок мужчины - помочь ребенку найти маму.').then((result) =>{msgForDelete.push(result.message_id);});  
    await waitFor(500);
...
bot.action('page1_6', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Пока вы плыли, вы все время смотрели на мимо проплывающие берега, люди... как их было много и как им было тяжело... Неужели они это заслужили за то, что просто были не крещенными..?').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, varia.razgovor1).then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
...
bot.action('page1_7', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, varia.razgovor1_2).then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Но времени у вас не было, сзади вас объвился Харон, перевозивший души людей. Освободив их, он правился к вам.\n- Поздравляю с прохождением первого круга. Если бы ты был не крещен, может я бы и заставил тебя пострадать, но нет. Ладно, я пойду, ворота открыты, ты можешь идти. Хотя стой...').then((result) =>{msgForDelete.push(result.message_id);});   
    await waitFor(500);
...
bot.action('page2_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы пошли по указанной Стражем дорожке. Он так и не представился и не захотел вести диалог. Вы решили не навязываться, так что просто пошли дальше.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '...').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Наконец-то вы дошли до нужного места. Вам понадобилось минут 10, чтобы подняться на эту гору, откуда было видно красоты этих безумных торнадо. Где-то вдали виднелись ворота на следующий круг...').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Осмотревшись вокруг, вы заметили тропинку дальше, которая вела вниз. Понаблюдав за ней, вы заметили, что она имеет разделение на дальнейшие тропинки. Да и кроме этого, одну из них не зацепляло Торнадо - это была левая тропинка. Дальше вы не видели куда идти, но возможно это был своеобразный лабиринт.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page2_2_0', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Подойдя к ним вы спросили:\n- Что случилось?\n Девушка сказала, что это её муж, и его слишком сильно ударило. Ему нужна помощь или иначе он будет калекой до конца своих дней, чего она очень не хотела.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
...
bot.action('page2_2_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы подняли мужчину на плечо и понесли его до небольшой хижины на окраине леса...').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '...').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Когда вы наконец-то дошли, девушка была невероятно благодарна вам. Она удивилась, что тут еще оставались те, кто может помочь другим и не потеряли свою личность. Она утверждала, что здесь недавно, так что понимает, что тут происходит, а эта хижина... Она её нашла случайно, но часто сюда не ходит, ибо Минос следит за всеми. Так вы и узнали имя Стража.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page2_2_5', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Попытавшись обойти, вы нашли мост. Действительно, он там был и это вам сэкономило время. Вы решили пройти по нему...').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
        source: "photos/2_most.jpg"
    }).then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Проходя мимо этой бури, вы даже представить не могли, как бы вам пришлось обходить это все.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '...').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
...
bot.action('page2_labl', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы шли по тропинке, как тут же торнадо схватило вас и начало вместе с другими людьми носить по кругу... Вы потеряли сознание...').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page2_wall', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы направились по дорожке. В определенный момент стала видеться стена...').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page2_3', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'И это оказалось ВЕРНО! Вы прошли без каких-либо происшествий до следущеюго выбора.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
...
bot.action('page2_4', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы шли и заметили рядом с вами расколотую землю. Достаточно опасно, но пройдя далее, вы дошли до следующего пересечения путей, так что вы выбрали верный путь!').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
...
bot.action('page2_8', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Наконец-то вы подходили к воротам, но вас там уже ждали... Это был Страж. И он явно хотел сказать вам что-то перед вашим уходом.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, part2_way).then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
...
bot.action('page3_0', async (ctx, next) => {
    ...
    msgForDelete = [];
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Глава 3: "Встреча с Вергилием"').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
        source: "photos/3_1.jpg"
    }).then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Зайдя внутрь, вы встретили Вергилия.\n- Привет Вергилий, как ты?\n- Нет времени для разговоров. Ситуация критическая, нужно быстрее закончить испытания, на которые ты попал...\n- Что случилось?... Я вроде неплохо проходил их...\n- НЕТ! Это все неважно! Идёшь быстро за мной, я тебе позже все объясню.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы ничего не поняли, но Вергилий вас быстро потянул за собой.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
...
bot.action('page3_2_2', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы выбрали путь по которому ходили мученники, но как оказалось это был неправииьный путь. Земля под ногами была как слякоть, а ваша одежда начала таить. Видимо Страж решил перекинуть наказание на вас.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
...
bot.action('page5_0', async (ctx, next) => {
    ...
    msgForDelete = [];
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Глава 4: "Те, кто ненавидят себя"').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Зайдя на следующий круг, вы увидели сильный туман и лодку.\n- Не будем терять времени, пошли сядем в лодку.\n- Вергилий, что случилось? Почему мы пробежали мимо Стражей..? Нам за это ничего не будет? Цербер вообще хотел нас разорвать...\n- Ну.. Я не ожидал такой реакции от Цербера, но вот Плутос знал, что нас пропустит. Он рад, когда все быстро заканчивается.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page5_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Течение стало меняться. В момент, когда Вергилий уснул, лодку стало заносить по течению в сторону, которую они плыли.').then((result) =>{msgForDelete.push(result.message_id);});    
    await waitFor(500);
...
bot.action('page5_2', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы продолжили следить за течением и казалось, что вы близки к берегу, как тут услышали странный голос из тумана...\n- Кто тут? - попытались заговорить вы...').then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '- Привет, Сандро, как дела?').then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(500);
...
bot.action('page5_5', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '- Доброе утро, Сандро.\n- О Вергилий, ты такое пропустил...\n- Слушай, Садро. Я понимаю, что тебе одиноко, но разговаривать с самим собой - это ненормально.\n- Стоп, ты всё слышал?\n- Верно.\n- Но я говорил с туманом.\n- Ты хоть слышишь, что говоришь? Да-с, видимо ты уже плохо соображаешь.').then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Сандро решил просто промолчать, но в любом случае, они были около ворот.').then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(500);
...
bot.action('page6_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '- Я забыла надеть маску, подождите, не подымайте головы. Если вы сделаете это, то вы превратитесь в камень... Хотя это было бы забано... - Видимо Медузе было скучно в этом городе...').then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Как только вы сели за стол. Она сразу переша к делу:\n- Значит, Сандро, ты должен ответить на 3 моих вопроса. Ответил - молодец, не ответил - просто уходишь. Иначе превращу в камень. Думаю тебе все понятно, так что я начинаю.').then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(500);
...
bot.action('page6_2', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Хорошо, следущий вопрос.').then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(500);
...
bot.action('page6_3', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Хорошо, последний вопрос.').then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(500);
...
bot.action('page6_4_2', async (ctx, next) => {
    ...
    varia.result = varia.result - 1;
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Этого достаточно. Я услышала все, что хотела, так что я вас отправляю дальше. Удачи...').then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(500);
...
bot.action('page8_0', async (ctx, next) => {
    ...
    await waitFor(200);
	await bot.telegram.sendMessage(ctx.chat.id, varia.bog[0]).then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(200);
	await bot.telegram.sendMessage(ctx.chat.id, varia.bog[1]).then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(200);
	await bot.telegram.sendMessage(ctx.chat.id, varia.bog[2]).then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(200);
	await bot.telegram.sendMessage(ctx.chat.id, varia.bog[3]).then((result) =>{msgForDelete.push(result.message_id);});     
    await waitFor(200);
