...
<i>Если вы не знаете какое решение прять - пользуйтесь</i>`;
    bot.telegram.sendMessage(ctx.chat.id, html, {
        ...
        reply_markup: {
            inline_keyboard: [
                [
                    { text: '✖ Закрыть окно', callback_data: 'close' },
                ],
            ]
        }
    })
...
bot.action('paragraph_0', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id, 'Ответы на вопросы по порядку: 2,3,3').then((result) => {
...
bot.action('paragraph_1', async (ctx, next) => {
    msgForDelete.push( ctx.update.callback_query.message.message_id);
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id, 'Для получения бала ребёнка брать не нужно.').then((result) => {
        msgForDelete.push(result.message_id);
});})
...
bot.action('paragraph_2', async (ctx, next) => {
    msgForDelete.push( ctx.update.callback_query.message.message_id);
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id, 'Помогите женщине, но не соглашайтесь брать от неё награду.').then((result) => {
        msgForDelete.push(result.message_id);
});})
...
bot.action('paragraph_3', async (ctx, next) => {
    msgForDelete.push( ctx.update.callback_query.message.message_id);
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id, 'Бегите по скалам.').then((result) => {
        msgForDelete.push(result.message_id);
});})
...
bot.action('paragraph_4', async (ctx, next) => {
    msgForDelete.push( ctx.update.callback_query.message.message_id);
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id, 'Не плывите по течению и будьте вежливыми с голосом.').then((result) => {
        msgForDelete.push(result.message_id);
});})
...
bot.action('paragraph_5', async (ctx, next) => {
    msgForDelete.push( ctx.update.callback_query.message.message_id);
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id, 'Ответы на вопросы по порядку: 2,3,2').then((result) => {
        msgForDelete.push(result.message_id);
});})
...
bot.action('paragraph_6', async (ctx, next) => {
    msgForDelete.push( ctx.update.callback_query.message.message_id);
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id, 'Пропустите Вергилия ИЛИ сразу пойдите первыми, а потом выберите вариант "А может...".').then((result) => {
        msgForDelete.push(result.message_id);
});})
...
bot.action('page0_0', async (ctx, next) => {
    ...
    varia.result = 0;
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Глава 0: "Сумрачный Лес" ').then((result) => {
        msgForDelete.push(result.message_id);
        });
	await waitFor(500);
...
bot.action('page0_t_0', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Немного подумав, вы решили, что противоположностью назад, может быть только прямо. Дорожка прямо была хорошо проложена, вы были уверенны, что рано или поздно вы выйдите из этого леса...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
...
bot.action('page0_t_1', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Солнечный свет был все ярче и ярче. Вы почти покинули этот лес.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
...
bot.action('page0_r_0', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Чтобы не идти прямо, но и не назад вы решили пойти направо. Конечно, это было бы более правильно назвать по диагонале, но это было не важно...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
...
bot.action('page0_r_0_0', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Вы решили остаться и найти что-то полезное...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Где-то вдали вам послышались звуки диких животных, возможно они опасны...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
...
bot.action('page0_r_0_1', async (ctx, next) => {
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Вы сели на бревно и стали смотреть в огонь.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Справа от другого бревна лежала какая-то записка, заметив её, вы пересели на то древно и стали читать её.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
...
bot.action('page0_r_0_2', async (ctx, next) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Вы стали искать другие возможные записки, но ваши попытки были напрасны, ничего больше, кроме всякого мусора на траве, здесь не было.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page0_r_1', async (ctx, next) => {
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'У вас времени не было развлекаться у привала, вы шли уже по более хорошей дорожке и сейчас вам казалось, что выход уже рядом...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
...
bot.action('page0_d_0', async (ctx, next) => {
    ...
    dltMessages(ctx); 
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Вы проявили свою твердость характера, решив, что стоит пойти назад. Дорожка не была идеальной, но вы не собирались играть в эти игры...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
    ...
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id, 'Пройдя далее дорожка закончилась, но вы все же думали, что выход рядом... Очевидно было, что его здесь нет, но вы не сдавались...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page0_3_0', async (ctx, next) => {
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Вы решили взглянуть на плиты...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
...
bot.action('page0_3', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Вы подошли к воротам. Сами ворота были высотой метров 10, а стены вокруг еще больше. Странно, что вы не увидели это здание еще в лесу, но вы понимали, что вся проблема была в тумане.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
const regex = new RegExp("[^Сандро|Александр|59018206|Моё имя Сандро|Моё имя Александр]");
bot.hears(regex, async (ctx, next) => {
    console.log(ctx.from)
    await waitFor(500);
 await bot.telegram.sendMessage(ctx.chat.id,'Прошу, вводите только корректные данные') 
})
...
bot.hears('Александр', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Что!? Но ведь ты должен был уже быть за вратами... Твоё место, Александр, в Раю, но по ошибке ты оказался в этом лесу... Извини, что не узнал, просто сегодня еще кое-кто должен прийти. Так что назови мне свой номер и ты можешь проходить дальше. Главное, подойди к Харону, он тебя проведет...Так вот, я слушаю.') .then((result) => {
        msgForDelete.push(result.message_id);
        });})
...
bot.action('page0_5_1_f1', async (ctx, next) => {
    ...
    dltMessages(ctx); 
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Возможно, этот вопрос сложноват, но твой ответ не верный. Воплощение Истины в жизни - это Любовь!').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page0_5_1_f2', async (ctx, next) => {
    ...
    dltMessages(ctx); 
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Возможно, этот вопрос сложноват, но твой ответ не верный. Желание, устремленность к Истине - это Жизнь!').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'В следущий миг старик скинул капюшон с головы, и оттуда было видно лишь его череп, никакой плоти. Он стремительно продвинулся к вам и проткнул своим мечом...'+ varia.deadGlobal + varia.dead[2] ,{
...
bot.action('page0_5_2_f', async (ctx, next) => {
    ...
    dltMessages(ctx); 
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Сандро, ты живешь по этим заповедям, не зная их? Проваливай отсюда!').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'В следущий миг старик скинул капюшон с головы, и оттуда было видно лишь его череп, никакой плоти. Он стремительно продвинулся к вам и проткнул своим мечом...'+ varia.deadGlobal + varia.dead[2] ,{
...
bot.action('page0_5_3_f', async (ctx, next) => {
    ...
    dltMessages(ctx); 
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Такой вопрос учат в учебниках истории, а ты не смог на него ответить, мне жаль, но другого выбора нет!').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'В следущий миг старик скинул капюшон с головы, и оттуда было видно лишь его череп, никакой плоти. Он стремительно продвинулся к вам и проткнул своим мечом...'+ varia.deadGlobal + varia.dead[2],{
...
bot.action('page0_5_5', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Старик в черном немного был удивлен. Он был несомненно уверен, что единственный, кто мог сейчас прийти из леса - это был Сандро. Но он не мог видеть его лица, у него не было глаз. Конечно, по такой логике, он не мог и слышать, но такая возможность у него была и была намного развитой, чем у других.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'- Допустим, и как же тебя зовут?').then((result) => {
        msgForDelete.push(result.message_id);
        });
	await bot.telegram.sendMessage(ctx.chat.id,'Напишите ваше имя (Пример: Сандро)').then((result) => {
        msgForDelete.push(result.message_id);
        });
})
...
bot.action('page1_0', async (ctx, next) => {
    ...
    dltMessages(ctx);
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Глава 1: "Лимб"').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Зайдя за ворота, перед вами будто был другой мир. Со стороны и не скажешь, но внутри повсюду были скалы и реки. Люди плакали и горевали. Какие были их мотивы горечи, вы не знали, но было ясно, что это их наказание... Если вам до этого момента еще казалось, что это все какая-то шутка, то теперь такие мысли стали пропадать.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Вы прошли немного дальше и стали замечать все больше и больше мучеников...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page1_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'- Здравствуйте, ваше имя Харон?').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Он внимательно посмотрел на вас и сказал:\n- Здравствуй, назви своё имя и я, Харон, назову твой приговор. ').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Пример текста(соблюдайте в точности большие буквы): Моё имя Сандро').then((result) => {
        msgForDelete.push(result.message_id);
        });
})
...
bot.action('page1_2', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Вы направились к парню, которому целовали руки... ').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page1_3_1', async (ctx, next) => {
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Так и быть - Я освежу твою память!').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page1_3_0', async (ctx, next) => {
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'Так и быть - Я поведаю тебе эту тайну.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page1_4', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Вы направились в место, где была оставлена лодка для вас. Она была немного дальше от Харона и закрыта скалами и деревьями от грешников.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Проверив все ли на месте, вы убедились, что плыть можно. Он говорил, что ваша задача плыть по этому озеру прямо и тогда вы доплывёте до Ворот.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    await bot.telegram.sendMessage(ctx.chat.id,'...').then((result) => {
...
bot.action('page1_6_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id,'Вы решили помочь ему. Благородный поступок мужчины - помочь ребенку найти маму.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page1_6', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Пока вы плыли, вы все время смотрели на мимо проплывающие берега, люди... как их было много и как им было тяжело... Неужели они это заслужили за то, что просто были не крещенными..?').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, varia.razgovor1).then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page1_7', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, varia.razgovor1_2).then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Но времени у вас не было, сзади вас объвился Харон, перевозивший души людей. Освободив их, он правился к вам.\n- Поздравляю с прохождением первого круга. Если бы ты был не крещен, может я бы и заставил тебя пострадать, но нет. Ладно, я пойду, ворота открыты, ты можешь идти. Хотя стой...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page2_0', async (ctx, next) => {
    dltMessages(ctx);
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Глава 2: "Те, кто любили..."').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Зайдя на следующий круг, атмосфера покоя была полностью утерена. Теперь все ниже и ниже наказания были хуже и хуже. Тут повсюду бушевали торнадо... ').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Пройдя далее, вы заметили, что в этих торнадо были люди... Т.е. это были их наказания..? Вам казалось это странным, но люди в них носились то вправо, то влево. Никто из них не оставался на земле - все они взлетали...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page2_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы пошли по указанной Стражем дорожке. Он так и не представился и не захотел вести диалог. Вы решили не навязываться, так что просто пошли дальше.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '...').then((result) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Наконец-то вы дошли до нужного места. Вам понадобилось минут 10, чтобы подняться на эту гору, откуда было видно красоты этих безумных торнадо. Где-то вдали виднелись ворота на следующий круг...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Осмотревшись вокруг, вы заметили тропинку дальше, которая вела вниз. Понаблюдав за ней, вы заметили, что она имеет разделение на дальнейшие тропинки. Да и кроме этого, одну из них не зацепляло Торнадо - это была левая тропинка. Дальше вы не видели куда идти, но возможно это был своеобразный лабиринт.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page2_2_0', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Подойдя к ним вы спросили:\n- Что случилось?\n Девушка сказала, что это её муж, и его слишком сильно ударило. Ему нужна помощь или иначе он будет калекой до конца своих дней, чего она очень не хотела.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page2_2_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы подняли мужчину на плечо и понесли его до небольшой хижины на окраине леса...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '...').then((result) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы рассказали о своём пути, пока она обрабатывала раны, так что она решила сделать вам подарок. Она открыла какой-то старый сундук, в котором скорее всего было золото... Конечно, вы отказались принять этот подарок, так как вы даже не знаете, сможете ли выйти отсюда.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '...').then((result) => {
...
bot.action('page2_2_5', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Попытавшись обойти, вы нашли мост. Действительно, он там был и это вам сэкономило время. Вы решили пройти по нему...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Проходя мимо этой бури, вы даже представить не могли, как бы вам пришлось обходить это все.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '...').then((result) => {
...
bot.action('page2_2', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Зайдя в лабиринт, вам стало понятно, что тут вам поможет только удача. Обзор был очень мал, и, скорее всего, вам тут поможет только ваша внимательность.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '...').then((result) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вокруг были торнадо, но они вас не трогали... Может это и не так опасно, думали вы...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page2_labl', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы шли по тропинке, как тут же торнадо схватило вас и начало вместе с другими людьми носить по кругу... Вы потеряли сознание...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page2_end', async (ctx, next) => {
    ...
    dltMessages(ctx); 
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы шли по тропинке, как тут же земля под ногами просто пропала. Верно, вы оказались не возле обрыва, а прямо в нём. Вы падали вниз...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page2_wall', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы направились по дорожке. В определенный момент стала видеться стена...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page2_3', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'И это оказалось ВЕРНО! Вы прошли без каких-либо происшествий до следущеюго выбора.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page2_4', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы шли и заметили рядом с вами расколотую землю. Достаточно опасно, но пройдя далее, вы дошли до следующего пересечения путей, так что вы выбрали верный путь!').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page2_8', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Наконец-то вы подходили к воротам, но вас там уже ждали... Это был Страж. И он явно хотел сказать вам что-то перед вашим уходом.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, part2_way).then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page3_0', async (ctx, next) => {
    dltMessages(ctx);
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Глава 3: "Встреча с Вергилием"').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
    bot.telegram.sendPhoto(ctx.chat.id, {
...
bot.action('page3_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы побежали максимально далеко от Цербера, но его нюх не дал вам расслабиться... Он почувствовал вас, когда вы прошли мимо него, но когда он понял, что вы решили сбежать, то побежал за вами...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Скорость его бега была однозначно выше, так что вам нужно было двигаться быстрее. Вы двигались по безопасной дорожке, но нужно было срезать путь, так что вам оставалось 2 выбора, срезать через скалы или пробежать через мучеников.\n- Вергилий, куда побежим?\n- Я не могу сказать, что лучше... Давай лучше ты примешь решение.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page3_2_2', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы выбрали путь по которому ходили мученники, но как оказалось это был неправииьный путь. Земля под ногами была как слякоть, а ваша одежда начала таить. Видимо Страж решил перекинуть наказание на вас.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page5_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Течение стало меняться. В момент, когда Вергилий уснул, лодку стало заносить по течению в сторону, которую они плыли.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page5_5', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '- Доброе утро, Сандро.\n- О Вергилий, ты такое пропустил...\n- Слушай, Садро. Я понимаю, что тебе одиноко, но разговаривать с самим собой - это ненормально.\n- Стоп, ты всё слышал?\n- Верно.\n- Но я говорил с туманом.\n- Ты хоть слышишь, что говоришь? Да-с, видимо ты уже плохо соображаешь.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Сандро решил просто промолчать, но в любом случае, они были около ворот.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page6_0', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Зайдя внутрь вы увидели разрушенный город... Повсюду были черти и мифические твари. Странное место, подумали вы...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page6_1', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, '- Я забыла надеть маску, подождите, не подымайте головы. Если вы сделаете это, то вы превратитесь в камень... Хотя это было бы забано... - Видимо Медузе было скучно в этом городе...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Как только вы сели за стол. Она сразу переша к делу:\n- Значит, Сандро, ты должен ответить на 3 моих вопроса. Ответил - молодец, не ответил - просто уходишь. Иначе превращу в камень. Думаю тебе все понятно, так что я начинаю.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page6_2', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Хорошо, следущий вопрос.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page6_3', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Хорошо, последний вопрос.').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page6_4_2', async (ctx, next) => {
    ...
    varia.result = varia.result - 1;
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Этого достаточно. Я услышала все, что хотела, так что я вас отправляю дальше. Удачи...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page7_0', async (ctx, next) => {
    dltMessages(ctx);
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Глава 6: "Вопрос Дружбы"').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы оказались в темном холодном месте. Вокруг был лёд... Немного пройдя вперед, вы глянули вниз, а там обнаружили ледяное озеро. Внизу были люди, которые кричали от боли. Их наказание заключалось в вечном прибывании под льдом...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(500);
...
bot.action('page7_5_2', async (ctx, next) => {
    ...
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы решили пропустить Вергилия первым. Это благородный поступок за который вы решили расплотиться муками в холодном льду. Страж превратил вас в одного из мучеников и кинул вас в воду. Почти сразу вы заледенели и вам пришлось терпеть невыносимую боль целую неделю...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await bot.telegram.sendMessage(ctx.chat.id, '...').then((result) => {
        msgForDelete.push(result.message_id);
...
bot.action('page8_0', async (ctx, next) => {
    ...
    func.showMessage();
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, 'Вы шли по коридору пока не услышали голос:\n-Сандро, ты прибыл.\nВы не ожидали, что он лично решит судить вас... Бог появился перед вами.\n- Я буду судить тебя! Достоин ли ты снова быть под моей защитой? Сейчас ты узнаешь.\nВы были так испуганы, что не могли сказать даже слова... Это был шок для вас...').then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(200);
	await bot.telegram.sendMessage(ctx.chat.id, varia.bog[0]).then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(200);
	await bot.telegram.sendMessage(ctx.chat.id, varia.bog[1]).then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(200);
	await bot.telegram.sendMessage(ctx.chat.id, varia.bog[2]).then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(200);
	await bot.telegram.sendMessage(ctx.chat.id, varia.bog[3]).then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(200);
...
bot.action('page8_1', async (ctx, next) => {
    await waitFor(500);
	await bot.telegram.sendMessage(ctx.chat.id, varia.message1[0]).then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(200);
	await bot.telegram.sendMessage(ctx.chat.id, varia.message1[1]).then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(200);
	await bot.telegram.sendMessage(ctx.chat.id, 'Результат:\n\n' + varia.dead[0] + varia.dead[1] + varia.dead[2] + varia.dead[3] + varia.dead[4] + varia.dead[5] + varia.dead[6] + varia.dead[7] + '\n\nВсе Финалы игры\n\n' + varia.end[0] + '\n\n' + varia.end[1] + '\n\n' + varia.end[2] + '\n\nВаша карма:  ' + varia.result ).then((result) => {
        msgForDelete.push(result.message_id);
        });
    await waitFor(200);
